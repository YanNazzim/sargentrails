...
].sort((a, b) => parseInt(a.value) - parseInt(b.value)); // Sort the array by the numerical value of the 'value' field.
...
const MortiseLockbodies = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (selectedFunction && selectedHanding && selectedFinish) {
  ...
  return (
    <div className="content-transition">
      <h1 className="Heading">8200 Mortise Lockbodies</h1>
      ...
      {/* Results */}
      {displayResult && selectedFunction && (
        <div className="result-container">
          <h2>Selected Lockbody Details:</h2>
          <p>
            <strong>Function:</strong> {selectedFunction.label}
          </p>
          <p>
            <strong>Handing:</strong> {selectedHanding.label}
          </p>
          <p>
            <strong>Finish:</strong> {selectedFinish.label}
          </p>
          <p>
...
export default MortiseLockbodies;