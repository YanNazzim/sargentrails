...
const lockbodyFunctions = [
  // Functions from "Deadbolt Only"
  {
    ...
    description: "Deadbolt only operation. Key outside retracts and projects deadbolt. Thumbturn inside retracts deadbolt only, will not project it.",
    image: null,
  },
  // Functions from "Single Cylinder without Deadbolt"
  {
    ...
    description: "Key outside retracts latchbolt. Trim outside locked at all times. Trim inside always retracts latchbolt. Auxiliary deadlatch.",
    image: null,
  },
  {
    value: "8205",
    label: "8205 - Office or Entry (F04)",
    description: "Key outside retracts latchbolt, also locks & unlocks outside trim. Trim inside always retracts latchbolt, trim outside remains locked. Thumbturn inside locks & unlocks outside trim. Auxiliary deadlatch. A Multi-Function 8200/7800 Lockbody.",
    image: null,
  },
  {
    value: "8206",
    label: "8206 - Storeroom or Service",
    description: "Trim inside always retracts latchbolt. Auxiliary deadlatch. A Multi-Function 8200/7800 Lockbody. Same as 04 Function without trim outside.",
    image: null,
  },
  // Functions from "Non-Keyed"
  {
    ...
    description: "For doors with indicator that do not require locking. Latchbolt retracted by trim either side at all times. Throwing thumbturn on inside changes state of status indicator. Rotating either trim returns indicator to previous state. Note: Only available with \"V\" series indicators. Indicator option code must be specified with this function.",
    image: null,
  },
  {
    value: "8213",
    label: "8213 - Exit Latch (F31)",
    description: "No outside trim or cylinder. Trim inside retracts latchbolt. A Multi-Function 8200/7800 Lockbody. Auxiliary deadlatch.",
    image: null,
  },
  {
    value: "8215",
  ...
  // Functions from "Double Cylinder without Deadbolt"
  {
    ...
    description: "Key outside retracts latchbolt. Key inside is required to lock and unlock trim outside. Trim inside always retracts latchbolt. Auxiliary deadlatch. Special-105 cam, required for inside cylinder (supplied).",
    image: null,
  },
  {
    value: "8217",
    label: "8217 - Asylum or Institutional (F30)",
    description: "Key from either side retracts latchbolt. Trim on both sides are locked at all times. Auxiliary deadlatch. CAUTION: Not recommended for use on any door used for Life Safety egress.",
    image: null,
  },
  // Functions from "Deadbolt Only"
  {
    ...
    description: "Deadbolt operation only. Key outside retracts and projects deadbolt. No inside operation.",
    image: null,
  },
  {
    value: "8221",
    label: "8221 - Deadlock (F17)",
    description: "Deadbolt operation only. Key outside retracts and projects deadbolt. Thumbturn inside retracts and projects deadbolt.",
    image: null,
  },
  {
    value: "8222",
    label: "8222 - Deadlock (F16)",
    description: "Deadbolt operation only. Key outside or inside retracts and projects deadbolt.",
    image: null,
  },
  {
    value: "8223",
    label: "8223 - Classroom Deadlock",
    description: "Deadbolt only operation. Key outside or inside retracts and projects deadbolt. Thumbturn inside retracts deadbolt, does not project deadbolt. Same as 03 function with cylinder inside. Not Available with Behavioral Health Trim.",
    image: null,
  },
  // Functions from "Single Cylinder with Deadbolt"
  {
    ...
    description: "Key outside or thumbturn inside retracts and projects deadbolt. Trim either side retracts latchbolt. Latchbolt & deadbolt operate independently of each other. CAUTION: Not recommended for use on any door used for Life Safety egress.",
    image: null,
  },
  {
    value: "8225",
    label: "8225 - Dormitory or Exit (F13)",
    description: "Key outside or thumbturn inside retracts and projects deadbolt. Trim from either side retracts latchbolt, when the deadbolt is in the retracted position. Trim outside is locked, when the deadbolt is projected. When deadbolt is projected, Trim inside retracts latchbolt and deadbolt simultaneously, unlocking outside trim.",
    image: null,
  },
  // Functions from "Double Cylinder with Deadbolt"
  {
    ...
    description: "Key from either side retracts & projects deadbolt. Trim from either side retracts latchbolt. Latchbolt and deadbolt are independent of each other. CAUTION: Not recommended for use on any door used for Life Safety egress.",
    image: null,
  },
  {
    value: "8227",
    label: "8227 - Closet or Storeroom",
    description: "Key outside retracts and projects deadbolt. Trim from either side retracts latchbolt. Same as 24 function without thumbturn. Latchbolt & deadbolt operate independently of each other. CAUTION: Not recommended for use on any door used for Life Safety egress.",
    image: null,
  },
  {
    value: "8228",
    label: "8228 - Dummy Trim Deadlock",
    description: "Deadbolt operation only. Key outside retracts and projects deadbolt. Trim inside always retracts deadbolt. Trim outside is always locked. Thumbturn inside retracts and projects deadbolt. Note: Indicator shows deadbolt position only.",
    image: null,
  },
  {
    value: "8229",
    label: "8229 - Dummy Trim Deadlock",
    description: "Deadbolt operation only. Key on either side retracts & projects deadbolt. Trim inside retracts deadbolt. Trim outside is always locked. Note: Indicator shows deadbolt position only.",
    image: null,
  },
  {
    value: "8230",
    label: "8230 - Dummy Trim Deadlock",
    description: "Deadbolt operation only. Key outside retracts and projects deadbolt. Trim inside always retracts deadbolt. Trim outside is always locked. Same as 28 Function without a thumbturn. Note: Indicator shows deadbolt position only.",
    image: null,
  },
  {
    value: "8231",
    label: "8231 - Utility",
    description: "Key outside retracts latchbolt. Trim outside is always locked. No inside trim or cylinder. A Multi-Function 8200/7800 Lockbody. Auxiliary deadlatch. CAUTION: Not recommended for use on any door used for Life Safety egress.",
    image: null,
  },
  {
    value: "8235",
    label: "8235 - Storeroom (F20)",
    description: "Key outside retracts and projects deadbolt. Trim outside retracts latchbolt, except when deadbolt is projected. No inside trim or cylinder. CAUTION: Not recommended for use on any door used for Life Safety egress.",
    image: null,
  },
  {
    value: "8236",
    label: "8236 - Closet",
    description: "Key locks and unlocks trim. No inside trim or cylinder. A Multi-Function 8200/7800 Lockbody. Auxiliary dead latch. CAUTION: Not recommended for use on any door used for Life Safety egress.",
    image: null,
  },
  {
    value: "8237",
    label: "8237 - Classroom (F05)",
    description: "Key outside retracts latchbolt, also locks & unlocks outside trim. Trim inside always retracts latchbolt. Auxiliary deadlatch. A Multi-Function 8200/7800 Lockbody.",
    image: null,
  },
  {
    value: "8238",
    label: "8238 - Classroom Security Intruder Latchbolt (F32)",
    description: "Key from either side locks & unlocks outside trim. Key from either side retracts latchbolt. Trim outside retracts latchbolt, except when locked. Trim inside always retracts latchbolt. A Multi-Function 8200/7800 Lockbody. Auxiliary deadlatch. Handed function; handing must be specified. This function is NOT field reversible for handing.",
    image: null,
  },
  {
    value: "8239",
    label: "8239 - Classroom Security Intruder Deadbolt (F33)",
    description: "Key either from side retracts or projects deadbolt which also unlocks or locks outside trim. Trim outside retracts latchbolt, except when locked. Trim outside is only locked by projecting the deadbolt. Trim inside retracts both latchbolt and deadbolt simultaneously, and unlocks outside trim.",
    image: null,
  },
  {
    value: "8240",
  ...
  },
  {
    ...
    description: "Key from either side retracts and projects deadbolt. Key from either side retracts latchbolt. Trim inside & outside are locked only when deadbolt is projected. CAUTION: Not recommended for use on any door used for Life Safety egress.",
    image: null,
  },
  {
    value: "8250",
    label: "8250 - Hotel Guest (F15)",
    description: "Hotel Cylinder (50 Function) Required (Standard & Emergency Keys). Standard Key retracts latchbolt only, will not retract or project deadbolt. Emergency Key (P/N 7268EMK ordered separately) will retract latchbolt & deadbolt and also project deadbolt. Thumbturn retracts & projects deadbolt. Trim inside retracts latchbolt & deadbolt simultaneously. Trim outside is always locked. Auxiliary deadlatch. Available with Conventional, LFIC (60- & 63-), Degree (60-, 63-, & 64-) and Keso (82- & F1-82-) key systems. Note: Indicator shows deadbolt position only.",
    image: null,
  },
  {
    value: "8251",
    label: "8251 - Storeroom Deadbolt",
    description: "Key and thumbturn both retract & project the deadbolt. Key will also retract latchbolt. Trim inside retracts latchbolt & deadbolt simultaneously. Trim outside is always locked. Auxiliary deadlatch. Same as 50 function with a standard cylinder. Note: Indicator shows deadbolt position only.",
    image: null,
  },
  {
    value: "8252",
    label: "8252 - Institutional Deadbolt",
    description: "Key from either side retracts and projects deadbolt. Key from either side retracts latchbolt. Trim inside and out are always locked. Auxiliary deadlatch. Note: Indicator shows deadbolt position only. CAUTION: Not recommended for use on any door used for Life Safety egress.",
    image: null,
  },
  {
    value: "8255",
    label: "8255 - Office or Entry",
    description: "Key outside retracts latchbolt. Trim inside always retracts latchbolt, outside trim remains locked. Trim outside is locked & unlocked by the toggle only. Auxiliary deadlatch.",
    image: null,
  },
  {
    value: "8256",
    label: "8256 - Office & Inner Entry Lock",
    description: "Key outside retracts latchbolt. Trim inside always retracts latchbolt and unlocks outside trim. Trim outside is locked by thumbturn or key. Auxiliary deadlatch.",
    image: null,
  },
  {
    value: "8257",
    label: "8257 - Institutional Privacy (F26)",
    description: "Key outside retracts latchbolt, overriding thumbturn when held in locked position. Thumbturn inside locks & unlocks outside trim. Trim outside unlocks when the door closes or operating trim inside. Trim inside always retracts latchbolt. Auxiliary deadlatch. Note: Key locks & unlocks trim outside.",
    image: null,
  },
  {
    value: "8258",
  ...
  },
  {
    ...
    description: "Trim on inside of door is always rigid. Trim only used as door pull. For double door applications, installed on the inactive door, use template #4298 to accept latchbolt from active door. Note: Lever is throughbolted-",
    image: null,
  },
  {
    value: "8294",
    label: "8294 - Trim Dummy",
    description: "Trim on both sides are always rigid. Trim only used as door pull. Recommended for double door applications on the inactive door, use template #4298, to accept latchbolt from active door. Note: Lever not surface mounted.",
    image: null,
  },
  {
    value: "8295",
    label: "8295 - Single Trim Dummy",
    description: "Trim inside only. Trim is always rigid. Includes lock case and armor front. Not recommended on double door applications (will not accept latchbolt from active door).",
    image: null,
  },
  {
    value: "8296",
    label: "8296 - Double Trim Dummy",
    description: "Trim on both sides of the door. Both trims are always rigid. Includes lock case and armor front. Not recommended on double door applications (will not accept latchbolt from active door).",
    image: null,
  },
  {
    value: "8297",
    label: "8297 - Active Trim Dummy",
    description: "Trim on both sides are active. Includes lock case and armor front. Not recommended on double door applications (will not accept latchbolt from active door).",
    image: null,
  },
...
const roseEscutcheonOptions = [
  // Roses
  { value: "ORose", label: "O Rose", image: null },
  { value: "CORose", label: "CO Rose", image: null },
  { value: "TORose", label: "TO Rose", image: null },
  { value: "E2Rose", label: "E2 Rose", image: null },
  { value: "E4Rose", label: "E4 Rose", image: null },
  { value: "LNRose", label: "LN Rose", image: null },
  { value: "CRRose", label: "CR Rose", image: null },
  { value: "TRRose", label: "TR Rose", image: null },
  { value: "E3Rose", label: "E3 Rose", image: null },
  // Escutcheons
  { value: "LE1Escutcheon", label: "LE1 Escutcheon", image: null },
  { value: "CEEscutcheon", label: "CE Escutcheon", image: null },
  { value: "TEEscutcheon", label: "TE Escutcheon", image: null },
];
...
const MortiseTrimKits = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      const roseEscutcheonShorthand = formData.roseEscutcheon.value.replace(/(Rose|Escutcheon)/g, '');
      ...
      <form onSubmit={handleSubmit} className="part-form">
        ...
        <div className="form-group">
          ...
          <Select
            ...
            onChange={(selectedOption) => handleChange(selectedOption, "functionCode")}
        ...
        <div className="form-group">
          ...
          <Select
            ...
            onChange={(selectedOption) => handleChange(selectedOption, "roseEscutcheon")}
        ...
        <div className="form-group">
          ...
          <Select
            options={leverStyles}
            onChange={(selectedOption) => handleChange(selectedOption, "leverStyle")}
        ...
        <div className="form-group">
          ...
          <Select
            ...
            onChange={(selectedOption) => handleChange(selectedOption, "handing")}
        ...
        <div className="form-group">
          ...
          <Select
            ...
            onChange={(selectedOption) => handleChange(selectedOption, "finish")}
